	...
	<div class="container-fluid delete-padding">
		<div class="body">
	    	<div class="container-for-photo">
				...
				<div class="single-main-image"><?php the_post_thumbnail(); ?></div>
		    ...
		    <div class="container">
                ...
                <div class="tags-container">
		       		<?php the_tags('<i class="fa fa-tags" aria-hidden="true"></i> ', ' <i class="fa fa-circle" aria-hidden="true"></i> ', ''); ?>
		       	</div>
		    </div>
							...
							<div class="col-xs-12">
								<div class="container-block">
									<div class="nothing-was-found">
										<h1>На жаль, нічого не було знайдено...</h1>
									</div>
								</div>
				        	</div>
						<?php 
